...
public class CPUTimeSeries implements Runnable{
	...
	private static String command = "iostat -c";  //mpstat -P ALL 
...
//
	  TextTitle copyright1 = new TextTitle("to show the infomation about the Linux CPU of the User Persent , System Persent and IO Wait Persent by using command <iostat -c>");  
